...
final data = <(String, dynamic, List<String>)>[
  (
  ...
  (
    ...
    [
      ...
      " vá em Minha Conta -> Configurações Gerais. A opção Minha Conta só está disponível para usuários cadastrados.",
    ],
    [
      "notificações",
      "receber",
  ...
  (
    ...
    [
      "Se você deseja encerrar sua conta no aplicativo, você pode fazê-lo na aba Mais ",
      Symbols.settings_rounded,
      " do aplicativo, logo clique em Minha Conta -> Excluir minha conta (em vermelho). Você precisará confirmar sua senha e aceitar os termos de encerramento da conta. Lembre-se que ao encerrar sua conta, você perderá todos os seus dados e resultados salvos no aplicativo.",
    ],
    [
      "encerrar",
      "deletar",
  ...
  (
    ...
    [
      "Sim, você pode acessar esse recurso na aba Mais ",
      Symbols.settings_rounded,
      " do aplicativo, ir em Minha Conta -> Nos dê um feedback! e enviar sua opinião ou reclamação. Nós agradecemos seu feedback e melhoraremos o aplicativo com base nele. O feedback só está disponível uma vez para cada usuário. Para mais informações mande um email para ",
